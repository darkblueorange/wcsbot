defmodule WcsBotWeb.Endpoint do
  use Phoenix.Endpoint, otp_app: :wcs_bot
  ...
  if code_reloading? do
    ...
    plug Phoenix.Ecto.CheckRepoStatus, otp_app: :wcs_bot
  end
